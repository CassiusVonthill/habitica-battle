        ...
        <v-form lazy-validation v-model="validForm" ref="authForm">
            <v-text-field
                ...
                <v-text-field
                    ...
                    <v-btn :loading="isLoading" :disabled="!validForm" color="purple" @click="authenticate"
                                                  >Authenticate</v-btn
                                              >
        </v-form>
    </div>
        ...
        authenticate() {
            if (
                ...
                this.$api.get('/user').then(res => {
                    this.alert.msg = 'Your credentials check out, please wait as we process some data...'
